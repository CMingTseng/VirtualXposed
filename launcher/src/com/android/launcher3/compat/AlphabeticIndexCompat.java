...
public class AlphabeticIndexCompat {
    ...
    /**
     * Base class to support Alphabetic indexing if not supported by the framework. TODO(winsonc):
    ...
    private static class AlphabeticIndexV16 extends BaseIndex {
        ...
        /**
         * Returns the index of the bucket in which {@param s} should appear. Function is
         * synchronized because underlying routine walks an iterator whose state is maintained
         * inside the index object.
         */
        protected int getBucketIndex(String s) {
            try {
