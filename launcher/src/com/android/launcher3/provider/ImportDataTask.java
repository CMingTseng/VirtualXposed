...
public class ImportDataTask {
    ...
    /**
     * 1) Imports all the workspace entries from the source provider. 2) For home screen entries,
     * maps the screen id based on {@param screenIdMap} 3) In the end fills any holes in hotseat
     * with items from default hotseat layout.
     */
