...
public class RestoreDbTask {
    ...
    /**
     * Makes the following changes in the provider DB. 1. Removes all entries belonging to a managed
     * profile as managed profiles cannot be restored. 2. Marks all entries as restored. The flags
     * are updated during first load or as the restored apps get installed. 3. If the user serial
     * for primary profile is different than that of the previous device, update the entries to the
     * new profile id.
     */
