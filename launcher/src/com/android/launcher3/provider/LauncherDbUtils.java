...
public class LauncherDbUtils {
    ...
    /**
     * Makes the first screen as screen 0 (if screen 0 already exists, renames it to some other
     * number). If the first row of screen 0 is non empty, runs a 'lossy' GridMigrationTask to clear
