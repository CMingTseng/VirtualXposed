...
public class PopupContainerWithArrow extends AbstractFloatingView implements DragSource,
     ...
     *
     * These are the preferred orientations, in order (RTL prefers right-aligned over left): - Above
     * and left-aligned - Above and right-aligned - Below and left-aligned - Below and
     * right-aligned
     *
     * So we always align left if there is enough horizontal space and align above if there is
     ...
     *
     * @param horizontalOffset the horizontal offset of the arrow, so that it points at the center
     ...
     *
     * Current behavior: - Start the drag if the touch passes a certain distance from the original
     * touch down.
     */
    ...
    /**
     * Animates the height of the notification item and the translationY of other items
     * accordingly.
     */
