...
public class AlphabeticalAppsList {
     ...
     *
     * If the number of predicted apps is the same as the previous list of predicted apps, we can
     * optimize by swapping them in place.
     */
     ...
     *
     * Note: This should only be called if the # of predicted apps is the same. This method assumes
     * that predicted apps are the first items in the adapter.
     */
