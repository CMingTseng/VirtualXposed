...
public class Workspace extends PagedView
    ...
    /**
     * Hotseat alpha can be changed when moving horizontally, vertically, changing states. The
     * values correspond to {@link Direction#X}, {@link Direction#Y} & {@link
     * #HOTSEAT_STATE_ALPHA_INDEX} respectively.
     */
     ...
     *
     * The layout will be: - The Hotseat if the drag object is over it - A side page if we are in
     ...
     * update, this is called to ensure that other widgets and application shortcuts are not
     * removed.
     */
