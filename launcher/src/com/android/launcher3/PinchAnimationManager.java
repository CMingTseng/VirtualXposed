 ...
 *
 * It will look like this pinching in: - Workspace scales down - At some threshold 1, hotseat and
 * QSB fade out (full animation) - At a later threshold 2, panel buttons fade in and scrim fades in
 * - At a final threshold 3, snap to overview
 *
 * Pinching out: - Workspace scales up - At threshold 1, panel buttons fade out - At threshold 2,
 * hotseat and QSB fade in and scrim fades out - At threshold 3, snap to workspace
 *
...
public class PinchAnimationManager {
    ...
    /**
     * Interpolate from {@param currentProgress} to {@param toProgress}, calling {@link
     * #setAnimationProgress(float)} throughout the duration. If duration is -1, the default
     * overview transition duration is used.
     */
     ...
     *
     * @param interpolatedProgress The progress from 0 to 1, where 0 is overview and 1 is
     *                             workspace.
     */
     ...
     *
     * @param threshold    One of {@link PinchThresholdManager#THRESHOLD_ONE}, {@link
     *                     PinchThresholdManager#THRESHOLD_TWO}, or {@link PinchThresholdManager#THRESHOLD_THREE}
     * @param startState   {@link Workspace.State#NORMAL} or {@link Workspace.State#OVERVIEW}.
     * @param goingTowards {@link Workspace.State#NORMAL} or {@link Workspace.State#OVERVIEW}. Note
     *                     that this doesn't have to be the opposite of startState;
     */
