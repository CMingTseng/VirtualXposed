 ...
 * [ 1][  ][ 2][  ] [  ][  ][ 3][  ] [  ][ 4][  ][  ] [  ][ 5][ 6][ 7]
 * </ul>
 * *<p> For testing, one can use a BT keyboard, or use following adb command. ex. $ adb shell input
...
public class FocusLogic {
     ...
     *
     * Example of the check order for KEYCODE_DPAD_DOWN: [  ][  ][  ][ X][  ][  ][  ] [  ][  ][ 5][
     * 1][ 4][  ][  ] [  ][10][ 7][ 2][ 6][ 9][  ] [14][12][ 9][ 3][ 8][11][13]
     */
    // TODO: add unit tests to verify all permutation.
    ...
    /**
     * @param edgeColumn the column of the new icon. either {@link #NEXT_PAGE_LEFT_COLUMN} or {@link
