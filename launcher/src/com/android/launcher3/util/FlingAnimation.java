...
public class FlingAnimation implements AnimatorUpdateListener, Runnable {
    ...
    /**
     * The fling animation is based on the following system - Apply a constant force in the x
     * direction to causing the fling to decelerate. - The animation runs for the time taken by the
     * object to go out of the screen. - Calculate a constant acceleration in y direction such that
     * the object reaches {@link #mIconRect} in the given time.
     */
