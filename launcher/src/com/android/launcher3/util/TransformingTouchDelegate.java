...
/**
 * This class differs from the framework {@link TouchDelegate} in that it transforms the coordinates
 * of the motion event to the provided bounds.
 *
...
public class TransformingTouchDelegate extends TouchDelegate {
    ...
    /**
     * Will forward touch events to the delegate view if the event is within the bounds specified in
     * the constructor.
     *
