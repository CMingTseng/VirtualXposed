...
/**
 * This is a utility class that keeps track of all the tag that can be enabled to debug a behavior
 * in runtime.
 *
...
public class LogConfig {
    ...
    /**
     * After this tag is turned on, whenever there is n user event, debug information is printed out
     * to logcat.
     */
