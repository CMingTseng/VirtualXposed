...
public class ShortcutsItemView extends PopupItemView implements View.OnLongClickListener,
    ...
    /**
     * Sets all shortcuts in {@link #mShortcutsLayout} to VISIBLE, then creates an animation to
     * reveal the newly shown shortcuts.
     *
    ...
    /**
     * Animates the translationY of the view from the given offset to the view's current
     * translation
     *
