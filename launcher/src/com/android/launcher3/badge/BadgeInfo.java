...
public class BadgeInfo {
    ...
    /**
     * The current sum of the counts in {@link #mNotificationKeys}, updated whenever a key is added
     * or removed.
     */
    ...
    /**
     * When retrieving the notification icon, we draw it into this shader, which can be clipped as
     * necessary when drawn in a badge.
     */
    ...
    /**
     * Whether newBadge represents the same PackageUserKey as this badge, and icons with this badge
     * should be invalidated. So, for instance, if a badge has 3 notifications and one of those
     * notifications is updated, this method should return false because the badge still says "3"
     * and the contents of those notifications are only retrieved upon long-click. This method
     * always returns true when adding or removing notifications, or if the badge has a notification
     * icon to show.
     */
