...
public class LauncherIcons {
    ...
    /**
     * If the platform is running O but the app is not providing AdaptiveIconDrawable, then shrink
     * the legacy icon and set it as foreground. Use color drawable as background to create
