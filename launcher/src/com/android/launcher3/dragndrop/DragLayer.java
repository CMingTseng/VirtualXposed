...
public class DragLayer extends InsettableFrameLayout {
     ...
     * @param from               The initial location of the view. Only the left and top parameters
     *                           are used.
     * @param to                 The final location of the view. Only the left and top parameters
     *                           are used. This location doesn't account for scaling, and so should
     *                           be centered about the desired final location (including scaling).
