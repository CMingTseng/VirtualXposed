...
public class ExtractedColors {
    ...
    /**
     * Loads colors and wallpaper id from {@link Utilities#getPrefs(Context)}. These were saved
     * there in {@link ColorExtractionService}.
     */
    ...
    /**
     * The hotseat's color is defined as follows: - 12% black for super light wallpaper - 18% white
     * for super dark - 25% white otherwise
     */
