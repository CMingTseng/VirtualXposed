...
public class ExtractionUtils {
    ...
    /**
     * Extract colors in the :wallpaper-chooser process, if the wallpaper id has changed. When the
     * new colors are saved in the LauncherProvider, Launcher will be notified in
     * Launcher#onSettingsChanged(String, String).
     */
...
//                .setMinimumLatency(0).build());
    ...
    /**
     * Given a color, returns true if that color is legible on the given wallpaper color swatches,
     * else returns false.
     */
