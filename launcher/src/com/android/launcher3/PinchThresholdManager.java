...
/**
 * Keeps track of when thresholds are passed during a pinch gesture, used to inform {@link
 * PinchAnimationManager} throughout.
 *
...
public class PinchThresholdManager {
    ...
    /**
     * Uses the pinch progress to determine whether a threshold has been passed, and asks the
     * {@param animationManager} to animate if so.
     *
     ...
     * @return The last passed threshold, one of {@link PinchThresholdManager#THRESHOLD_ZERO},
     * {@link PinchThresholdManager#THRESHOLD_ONE}, {@link PinchThresholdManager#THRESHOLD_TWO}, or
