...
public class AutoInstallsLayout {
     ...
     * later. If there are extras, those are passed to widget options during bind. The config
     * activity for the widget (if present) is not shown, so any optional configurations should be
     * passed as extras and the widget should support reading these widget options.
     */
