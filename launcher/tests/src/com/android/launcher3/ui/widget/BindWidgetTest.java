...
public class BindWidgetTest extends AbstractLauncherUiTest {
    ...
    /**
     * Adds {@param item} on the homescreen on the 0th screen at 0,0, and verifies that the widget
     * class is displayed on the homescreen.
     *
     ...
     *
     * @param bindWidget if true the info is bound and a valid widgetId is assigned to the
