...
public class VAccountManager {
    ...
    /**
     * Asks the user to add an account of a specified type.  The authenticator for this account type
     * processes this request with the appropriate user interface.  If the user does elect to create
     * a new account, the account name is returned.
     * <p>
