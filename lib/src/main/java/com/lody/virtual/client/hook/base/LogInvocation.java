...
/**
 * Add this annotation to a {@link MethodProxy} or a {@link MethodInvocationStub} to log all the
...
public @interface LogInvocation {
    ...
    static enum Condition {
        ...
        /**
         * Logs every call. Mostly useful for debugging.
         */
        ALWAYS {
            public int getLogLevel(boolean isHooked, boolean isError) {
        ...
        /**
         * Logs only calls that exited with error A reasonable tradeoff between noise and getting
        ...
        /**
         * Log only calls that haven't been hooked It only makes sense on a MethodInvocationProxy,
         * and is useful to pinpoint missing methods
         */
        NOT_HOOKED {
            public int getLogLevel(boolean isHooked, boolean isError) {
