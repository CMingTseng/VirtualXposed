 ...
 * @author Lody
 * <p>
 * This class is responsible with: - Instantiating a {@link MethodInvocationStub.HookInvocationHandler}
 * on {@link #getInvocationStub()} ()} - Install a bunch of {@link MethodProxy}s, either with a
 * @{@link Inject} annotation or manually calling {@link #addMethodProxy(MethodProxy)} from {@link
 * #onBindMethods()} - Install the hooked object on the Runtime via {@link #inject()}
 * <p>
