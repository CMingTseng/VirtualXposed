...
public class ChooseTypeAndAccountActivity extends Activity
    ...
    /**
     * A Parcelable ArrayList of Account objects that limits the choosable accounts to those in this
     * list, if this parameter is supplied.
     */
    public static final String EXTRA_ALLOWABLE_ACCOUNTS_ARRAYLIST = "allowableAccounts";

    /**
     * A Parcelable ArrayList of String objects that limits the accounts to choose to those that
     * match the types in this list, if this parameter is supplied. This list is also used to filter
     * the allowable account types if add account is selected.
     */
    public static final String EXTRA_ALLOWABLE_ACCOUNT_TYPES_STRING_ARRAY = "allowableAccountTypes";

    /**
     * This is passed as the addAccountOptions parameter in AccountManager.addAccount() if it is
     * called.
     */
    public static final String EXTRA_ADD_ACCOUNT_OPTIONS_BUNDLE = "addAccountOptions";

    /**
     * This is passed as the requiredFeatures parameter in AccountManager.addAccount() if it is
     * called.
     */
    ...
    /**
     * Deprecated. Providing this extra to {@link ChooseTypeAndAccountActivity} will have no
     * effect.
     */
    @Deprecated
    ...
    /**
     * If set then this string willb e used as the description rather than the default.
     */
    ...
    /**
     * The default activity theme shows label at the top. Set a theme which does not show label,
     * which effectively makes the activity invisible. Note that no content is being set. If
     * something gets set, using this theme may be useless.
     */
    ...
    /**
     * Overrides the description text view for the picker activity if specified by the intent. If
     * not specified then makes the description invisible.
     */
    ...
    /**
     * Populates the UI ListView with the given list of items and selects an item based on {@code
     * mSelectedItemIndex} member variable.
     */
