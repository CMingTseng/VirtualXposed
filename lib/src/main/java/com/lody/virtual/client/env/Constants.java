...
public class Constants {
    ...
    /**
     * If an apk declared the "fake-signature" attribute on its Application TAG, we will use its
     * signature instead of the real signature.
     *
     * For more detail, please see : https://github.com/microg/android_packages_apps_GmsCore/blob/master/
