...
public class BroadcastSystem {
    ...
    /**
     * FIX ISSUE #171: java.lang.AssertionError: Register too many Broadcast Receivers at
     * android.app.LoadedApk.checkRecevierRegisteredLeakLocked(LoadedApk.java:772) at
     * android.app.LoadedApk.getReceiverDispatcher(LoadedApk.java:800) at
     * android.app.ContextImpl.registerReceiverInternal(ContextImpl.java:1329) at
     * android.app.ContextImpl.registerReceiver(ContextImpl.java:1309) at
     * com.lody.virtual.server.am.BroadcastSystem.startApp(BroadcastSystem.java:54) at
     * com.lody.virtual.server.pm.VAppManagerService.install(VAppManagerService.java:193) at
     * com.lody.virtual.server.pm.VAppManagerService.preloadAllApps(VAppManagerService.java:98) at
     * com.lody.virtual.server.pm.VAppManagerService.systemReady(VAppManagerService.java:70) at
     * com.lody.virtual.server.BinderProvider.onCreate(BinderProvider.java:42)
     */
