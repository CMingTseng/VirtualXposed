...
/**
 * Simple bridge that allows file access across process boundaries without returning the underlying
 * {@link FileDescriptor}. This is useful when the server side needs to strongly assert that a
 * client side is completely hands-off.
 */
...
public class FileBridge extends Thread {
    ...
    /**
     * java.io always writes every byte it's asked to, or fails with an error. (That is, unlike Unix
     * it never just writes as many bytes as happens to be convenient.)
     */
