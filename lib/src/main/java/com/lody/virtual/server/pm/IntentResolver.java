...
public abstract class IntentResolver<F extends VPackage.IntentInfo, R extends Object> {
    ...
    /**
     * All of the MIME types that have been registered, such as "image/jpeg", "image/*", or
     * "{@literal *}/*".
     */
    ...
    /**
     * The base names of all of the MIME types with a sub-type wildcard that have been registered.
     * For example, a filter with "image/*" will be included here as "image" but one with
     * "image/jpeg" will not be included here. This also includes the "*" for the "{@literal *}/*"
     * MIME type.
     */
