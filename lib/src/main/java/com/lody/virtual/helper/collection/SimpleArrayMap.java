...
public class SimpleArrayMap<K, V> {
     ...
     * if the maps have different sizes. Otherwise, for each key in this map, values of both maps
     * are compared. If the values for any key are not equal, the method returns false, otherwise it
     * returns true.
     */
    @Override
     ...
     * this map contains itself as a key or a value, the string "(this Map)" will appear in its
     * place.
     */
    @Override
