 ...
 * traditional {@link java.util.HashSet}.  The design is very similar to {@link ArrayMap}, with all
 ...
 * that may contain large numbers of items.  It is generally slower than a traditional HashSet,
...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    /**
     * Create a new empty ArraySet.  The default capacity of an array map is 0, and will grow once
     ...
     * if the sets have different sizes.  Otherwise, for each value in this set, it checks to make
     * sure the value also exists in the other set. If any value doesn't exist, the method returns
     ...
     * this set contains itself as a value, the string "(this Set)" will appear in its place.
     */
    @Override
     ...
     * requires generating a number of temporary objects and allocates additional state information
     * associated with the container that will remain for the life of the container.</p>
     */
    @Override
     ...
     * @return Returns true if this array set contains a value for every entry in
     ...
     *
     * @param collection The collection whose contents are to be used to determine which values to
     *                   keep.
     * @return Returns true if any values were removed from the array set, else false.
     */
    @Override
