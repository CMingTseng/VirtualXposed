...
/**
 * A copy of the current platform (currently {@link android.os.Build.VERSION_CODES#KITKAT} version
 * of {@link android.util.SparseArray}; provides a removeAt() method and other things.
 */
public class SparseArray<E> implements Cloneable {
     ...
     * allocation to store the specified number of mappings.  If you supply an initial capacity of
     ...
     * and that multiple keys can map to the same value and this will find only one of them.
     ...
     * this map contains itself as a value, the string "(this Map)" will appear in its place.
     */
    @Override
