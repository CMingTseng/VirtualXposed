...
public class SyncInfo {
    ...
    /**
     * The start time of the current sync operation in milliseconds since boot. This is represented
     * in elapsed real time. See {@link android.os.SystemClock#elapsedRealtime()}.
     */
