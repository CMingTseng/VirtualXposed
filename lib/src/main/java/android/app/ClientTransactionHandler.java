...
/**
 * Defines operations that a {@link ClientTransaction} or its items can perform on client.
 *
 * @hide
 */
public abstract class ClientTransactionHandler {
    ...
    /**
     * Execute transaction immediately without scheduling it. This is used for local requests, so it
     * will also recycle the transaction.
     */
    ...
    /**
     * Get {@link ActivityThread.ActivityClientRecord} instance that corresponds to the provided
     * token.
     */
