        ...
        namespace detail {
            ...
            public:
                ...
                T *getNativePointer() {
                    ...
                    auto *value = reinterpret_cast<detail::BaseHybridClass *>(getFieldValue(
                            pointerField));
                    if (!value) {
                        throwNewJavaException("java/lang/NullPointerException",
                ...
                void setNativePointer(std::unique_ptr<T> new_value) {
                    static auto pointerField = javaClassStatic()->getField<jlong>("mNativePointer");
                    auto old_value = std::unique_ptr<T>(
                            reinterpret_cast<T *>(getFieldValue(pointerField)));
            ...
            local_ref <HybridDestructor> getHolder(T t) {
                static auto holderField = t->getClass()->template getField<HybridDestructor::javaobject>(
                        "mDestructor");
...
// convert to HybridClass* from jhybridobject
        ...
        public:
            ...
            static local_ref <JavaPart> newObjectCxxArgs(Args &&... args) {
                static bool isHybrid = detail::HybridClassBase::isHybridClassBase(
                        javaClassStatic());
        ...
        inline T *HybridClass<T, B>::JavaPart::cthis() {
            ...
            if (isHybrid) {
                ...
                static auto field =
                        HybridClass<T, B>::JavaPart::javaClassStatic()->template getField<detail::HybridData::javaobject>(
                                "mHybridData");
