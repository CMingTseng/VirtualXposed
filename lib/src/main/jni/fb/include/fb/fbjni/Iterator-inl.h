    ...
    namespace jni {
        ...
        namespace detail {
            ...
            struct MapIteratorHelper : public JavaClass<MapIteratorHelper<K, V>> {
                ...
                value_type next() {
                    static auto keyField = JavaBase_::javaClassStatic()->template getField<jobject>(
                            "mKey");
                    static auto valueField = JavaBase_::javaClassStatic()->template getField<jobject>(
                            "mValue");
                    return std::make_pair(dynamic_ref_cast<K>(JavaBase_::getFieldValue(keyField)),
                                          dynamic_ref_cast<V>(
                                                  JavaBase_::getFieldValue(valueField)));
                }
        ...
        typename JIterator<E>::Iterator JIterator<E>::begin() const {
            ...
            return Iterator(
                    make_global(
                            detail::IteratorHelper<E>::javaClassStatic()->newObject(ctor,
                                                                                    this->self())));
        }
        ...
        typename JMap<K, V>::Iterator JMap<K, V>::begin() const {
            ...
            return Iterator(
                    make_global(
                            detail::MapIteratorHelper<K, V>::javaClassStatic()->newObject(ctor,
                                                                                          this->self())));
        }
