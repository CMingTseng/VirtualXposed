    ...
    namespace jni {
        ...
        namespace {
            ...
            inline void encode3ByteUTF8(char32_t code, uint8_t *out) {
                FBASSERTMSGF((code & 0xffff0000) == 0,
                             "3 byte utf-8 encodings only valid for up to 16 bits");
            ...
            inline void encode4ByteUTF8(char32_t code, std::string &out, size_t offset) {
                FBASSERTMSGF((code & 0xfff80000) == 0,
                             "4 byte utf-8 encodings only valid for up to 21 bits");
...
// returns modified utf8 length; *length is set to strlen(str)
            ...
            void utf8ToModifiedUTF8(const uint8_t *utf8, size_t len, uint8_t *modified,
